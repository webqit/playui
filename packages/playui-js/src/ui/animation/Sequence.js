 ...
 * @imports
 */
import { _isFunction, _isNumber, _isEmpty } from '@webqit/util/js/index.js';
import { _last, _from as _arrFrom } from '@webqit/util/arr/index.js';
	...
	nowPlayingAdd(entry) {
        ...
        var compute = (nowPlaying, queue) => {
            ...
            if (_isNumber(params.lag) || _isNumber(params.endLag)) {
                var lastAnimation = _last(nowPlaying.$.animations);
                if (lastAnimation) {
